...
exports.main = async (context = {}, sendResponse) => {
  ...
  try {
    ...
    const contactAssocUrl = `https://api.hubapi.com/crm/v4/objects/deals/${propertiesToSend.hs_object_id}/associations/contacts?limit=500`;
    ...
    const companyAssocUrl = `https://api.hubapi.com/crm/v4/objects/deals/${propertiesToSend.hs_object_id}/associations/companies?limit=500`;
